      ...
      <div className="katalog__cards">
        <div className="katalog__card">
          <span className="katalog__icon">
            ...
            >
              <g clip-path="url(#clip0_12402_255)">
                <path
              ...
              <defs>
                <clipPath id="clip0_12402_255">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Telefon</p>
        </div>
        <div className="katalog__card">
          <span className="katalog__icon">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_12402_524)">
                <path
              ...
              <defs>
                <clipPath id="clip0_12402_524">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Kompyuter</p>
        </div>
        <div className="katalog__card">
          <span className="katalog__icon">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_12402_1823)">
                <path
              ...
              <defs>
                <clipPath id="clip0_12402_1823">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Aqilli soatlar</p>
        </div>
        <div className="katalog__card">
          <span className="katalog__icon">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_12402_1599)">
                <path
              ...
              <defs>
                <clipPath id="clip0_12402_1599">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Kamera</p>
        </div>
        <div className="katalog__card">
          <span className="katalog__icon">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_12402_716)">
                <path
                  d="M16.3333 30.3333H13.9999C11.4226 30.3333 9.33325 32.4226 9.33325 34.9999V41.9999C9.33325 44.5772 11.4226 46.6666 13.9999 46.6666H16.3333C18.9106 46.6666 20.9999 44.5772 20.9999 41.9999V34.9999C20.9999 32.4226 18.9106 30.3333 16.3333 30.3333Z"
                  stroke="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                />
                <path
                  d="M9.33325 34.9999V27.9999C9.33325 23.0492 11.2999 18.3013 14.8006 14.8006C18.3013 11.2999 23.0492 9.33325 27.9999 9.33325C32.9506 9.33325 37.6986 11.2999 41.1992 14.8006C44.6999 18.3013 46.6666 23.0492 46.6666 27.9999V34.9999"
                  stroke="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <defs>
                <clipPath id="clip0_12402_716">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Quloqchinlar</p>
        </div>
        <div className="katalog__card">
          <span className="katalog__icon">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_12402_603)">
                <path
                  d="M46.6667 14H9.33341C6.75609 14 4.66675 16.0893 4.66675 18.6667V37.3333C4.66675 39.9107 6.75609 42 9.33341 42H46.6667C49.2441 42 51.3334 39.9107 51.3334 37.3333V18.6667C51.3334 16.0893 49.2441 14 46.6667 14Z"
                  stroke="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M14 27.9999H23.3333M18.6667 23.3333V32.6666"
                  stroke="black"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <defs>
                <clipPath id="clip0_12402_603">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <p className="katalog__text">Aksesuarlar</p>
        </div>
      </div>
    </div>
  );
